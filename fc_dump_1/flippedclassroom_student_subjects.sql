...
CREATE TABLE `student_subjects` (
  ...
  KEY `FK9wolb5hopew1gxvwjbx7w2ura` (`department`,`subjects_subid`),
  KEY `FKpua58lpobui850uek8l76lubl` (`student_sid`),
  CONSTRAINT `FK9wolb5hopew1gxvwjbx7w2ura` FOREIGN KEY (`department`, `subjects_subid`) REFERENCES `subject` (`department`, `subid`),
  CONSTRAINT `FKpua58lpobui850uek8l76lubl` FOREIGN KEY (`student_sid`) REFERENCES `student` (`sid`)
