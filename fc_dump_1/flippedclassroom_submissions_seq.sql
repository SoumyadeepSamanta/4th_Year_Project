...
--
-- Dumping data for table `submissions_seq`
--

LOCK TABLES `submissions_seq` WRITE;
/*!40000 ALTER TABLE `submissions_seq` DISABLE KEYS */;
INSERT INTO `submissions_seq` VALUES (101);
/*!40000 ALTER TABLE `submissions_seq` ENABLE KEYS */;
UNLOCK TABLES;
