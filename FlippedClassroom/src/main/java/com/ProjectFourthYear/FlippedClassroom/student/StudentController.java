...
public class StudentController {
    ...
    public ResponseEntity<ResponseMessage> uploadFile(@RequestParam("file") MultipartFile file) {
        ...
        if (!ExcelHelperStudent.hasExcelFormat(file)) {
    ...
    public List<AssignmentDTO> getAssignments(@PathVariable String department,@PathVariable String subid) {
        return studentService.getAssignments(department,subid);
    }

    @PostMapping("/authenticate")
    public List<StudentDTO> checkPassword(@RequestParam String student_id){
        return studentService.checkPassword(student_id);
    }
    // @PostMapping("/{assignment_id}/{sub_id}/submission")
    // public Submissions addSubmissions(@PathVariable Long assignment_id,@PathVariable String sub_id, @RequestBody Submissions submission) {
    //     Submissions newSubmissions=studentService.addSubmissions(assignment_id,sub_id,submission);
